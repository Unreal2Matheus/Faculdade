function Configurar_Parametros(varargin)

global quad;
figure('units','normalized','position',[.4 .3 .2 .4],'name','Parâmetros do Quadrotor - UFJF','color','w','numbertitle','off');
...
quad.handler.Izz = uicontrol('units','normalized','position',[.45 .37 .35 .075],'style','edit','fontsize',10,'string',quad.Izz,'backgroundcolor','w');
quad.handler.xaxis.min = uicontrol('units','normalized','position',[.45 .29 .15 .075],'style','edit','fontsize',10,'string',quad.xaxis.min,'backgroundcolor','w');
quad.handler.xaxis.max = uicontrol('units','normalized','position',[.65 .29 .15 .075],'style','edit','fontsize',10,'string',quad.xaxis.max,'backgroundcolor','w');
quad.handler.yaxis.min = uicontrol('units','normalized','position',[.45 .21 .15 .075],'style','edit','fontsize',10,'string',quad.yaxis.min,'backgroundcolor','w');
quad.handler.yaxis.max = uicontrol('units','normalized','position',[.65 .21 .15 .075],'style','edit','fontsize',10,'string',quad.yaxis.max,'backgroundcolor','w');
quad.handler.zaxis.min = uicontrol('units','normalized','position',[.45 .13 .15 .075],'style','edit','fontsize',10,'string',quad.zaxis.min,'backgroundcolor','w');
quad.handler.zaxis.max = uicontrol('units','normalized','position',[.65 .13 .15 .075],'style','edit','fontsize',10,'string',quad.zaxis.max,'backgroundcolor','w');
...
uicontrol('units','normalized','position',[.2 .29 .2 .075],'style','text','fontsize',10,'string','Eixo X','backgroundcolor','w');
uicontrol('units','normalized','position',[.2 .21 .2 .075],'style','text','fontsize',10,'string','Eixo Y','backgroundcolor','w');
uicontrol('units','normalized','position',[.2 .13 .2 .075],'style','text','fontsize',10,'string','Eixo Z','backgroundcolor','w');



uicontrol('units','normalized','position',[.4 .05 .2 .05],'style','pushbutton','fontsize',10,'string','Aceitar','callback',@Aceitar_Configuracoes);

end



function Aceitar_Configuracoes(varargin)
