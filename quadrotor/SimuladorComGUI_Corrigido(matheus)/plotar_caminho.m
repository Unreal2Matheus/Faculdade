...
plot3([b1(1) b3(1)],[b1(2) b3(2)],[b1(3) b3(3)],'k','LineWidth',3)
hold on
plot3([b2(1) b4(1)],[b2(2) b4(2)],[b2(3) b4(3)],'k','LineWidth',3)
plot3([posicao(1) b5(1)],[posicao(2) b5(2)],[posicao(3) b5(3)],'k','LineWidth',3)
...
plot3(salvar.x_plot(1:100),salvar.y_plot(1:100),salvar.z_plot(1:100),'k')
hold on
plot3(salvar.x_des_plot(1:100),salvar.y_des_plot(1:100),salvar.z_des_plot(1:100),'--k')
grid